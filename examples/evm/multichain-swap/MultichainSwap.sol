...
contract MultichainSwap is AxelarExecutableWithToken {
    ...
    constructor(address _gateway, address _gasService, address _wmatic, address _weth) AxelarExecutableWithToken(_gateway) {
    ...
    function interchainSwap(
        ...
        gatewayWithToken().callContractWithToken(_destChain, _destContractAddr, encodedSwapPayload, _symbol, _amount);
    }
